...
public class Main {
    ...
    specific Google Cloud project.
     */
    private static void getAllComputeAssets(List<AssetObject> assetObjectList) {
        String zonesComputeUrl = ("https://compute.googleapis.com/compute/v1/projects/" +
                                    PROJECT_ID_EXP + "/zones").replace(PROJECT_ID_EXP, PROJECT_ID);
    ...
    specific Google Cloud project.
     */
    private static void getAllPubSubAssets(List<AssetObject> assetObjectList) {
        String pubSubUrl = ("https://pubsub.googleapis.com/v1/projects/" + PROJECT_ID_EXP + "/" +
                            ASSET_TYPE_EXP).replace(PROJECT_ID_EXP, PROJECT_ID);
    ...
    specific Google Cloud project.
     */
    private static void getAllStorageAssets(List<AssetObject> assetObjectList) {
        String storageUrl = ("https://storage.googleapis.com/storage/v1/" + ASSET_TYPE_EXP +
                            "?project=" + PROJECT_ID_EXP).replace(PROJECT_ID_EXP, PROJECT_ID);
    ...
    specific Google Cloud project.
     */
    private static void getAllCloudSqlAssets(List<AssetObject> assetObjectList) {
        String cloudSqlUrl = ("https://sqladmin.googleapis.com/sql/v1beta4/projects/" +
                            PROJECT_ID_EXP + "/" + ASSET_TYPE_EXP).replace(PROJECT_ID_EXP, PROJECT_ID);
